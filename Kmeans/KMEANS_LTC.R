...
LTC_train <- na.omit(LTC[1:199,]) #Treinamento entre 2017 - Jun/2018
LTC_test <- LTC[200:dim(LTC)[1],] #Teste entre Jul/2018 - Jun/2019
...
retorno_kmeans <- ifelse(  
                             ...
                             LTC_test$Cluster_predicao == 7|
                             LTC_test$Cluster_predicao == 5|
                             LTC_test$Cluster_predicao == 3|
...
#possivel overfitting 399 a 400
#muito provavel overftting de 299 a 300
#absurdo 199 a 200
